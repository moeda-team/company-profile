...
const services = [
  ...
  },
  {
    ...
    benefits: [
      "Scalable & scalable solutions for your success",
      "High ROI solutions",
      "Fast & clean development",
    ],
  ...
  },
  {
    ...
    benefits: [
      ...
      "Continuous updates & expert",
      "Proactive issue maintenance",
    ],
    image: "/images/maintenance.png",
    icon: (
      <svg width="26" height="26" viewBox="0 0 26 26" fill="none">
        <path d="M21 5.5l-3 3-2-2 3-3A6 6 0 005 11a6 6 0 006 6l8-8z" stroke="#FF6A00" strokeWidth="1.5" strokeLinejoin="round"/>
        <path d="M9 15l-5 5a1.4 1.4 0 002 2l5-5" stroke="#FF6A00" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      </svg>
    ),
  },
];
  ...
  return (
    <section className="s-features" id="about">
      <ScrollReveal className="s-intro">
        <h2 className="sh">Built for Real-World <span className="text-highlight">Impact</span></h2>
        <p className="sp">&quot;From intelligent automation to scalable system development and reliable support, we help businesses streamline operations and maximize performance.&quot;</p>
      </ScrollReveal>
