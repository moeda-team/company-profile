    ...
    <section className="s-product" id="portfolio">
      <ScrollReveal>
        <div className="product-header">
          <h2 className="sh">Our <span className="text-highlight">Project</span></h2>
          <p className="sp">&quot;We build integrated systems that simplify complex processes, enhance productivity, and create smooth, reliable experiences for both businesses and users.&quot;</p>
        </div>
      </ScrollReveal>
